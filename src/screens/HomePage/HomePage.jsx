...
const decorativeElements = [
  {
    src: "/48cf00c7-2587-4113-b6bb-8f9fd0a8d9da-removalai-preview-1.png",
    alt: "Element",
    className: "absolute top-[410px] left-[92px] w-[31px] h-[61px]",
  },
  {
    src: "/48cf00c7-2587-4113-b6bb-8f9fd0a8d9da-removalai-preview-2.png",
    alt: "Element",
    className: "absolute top-[171px] left-[986px] w-[81px] h-[98px]",
  },
  {
    src: "/48cf00c7-2587-4113-b6bb-8f9fd0a8d9da-removalai-preview-3.png",
    alt: "Element",
    className: "absolute top-[530px] left-[954px] w-[73px] h-[81px]",
  },
  {
    src: "/48cf00c7-2587-4113-b6bb-8f9fd0a8d9da-removalai-preview-4.png",
    alt: "Element",
    className: "absolute top-[150px] left-[296px] w-[54px] h-[70px]",
  },
  {
    src: "/a8b32876-91f6-4cab-8195-8e29797f7c94-removalai-preview-1.png",
    alt: "Ab f cab",
    className:
      "absolute top-[490px] left-[325px] w-[59px] h-[59px] object-cover",
  },
  {
    src: "/bb87b394-9410-4632-94c1-d993a45088e2-removalai-preview-1.png",
    alt: "Bbb",
    className:
  ...
  return (
    <main className="bg-[#0a0a0f] overflow-hidden w-full flex flex-col">
      ...
      <header className="relative w-full h-[700px]">
        ...
        <img
          className="absolute w-[132.01%] h-[30.05%] top-0 left-0"
          alt="Clip path group"
        ...
        <img
          className="absolute top-0 left-[1108px] w-[332px] h-[409px]"
          alt="Group"
          src="/group-19.png"
        />
